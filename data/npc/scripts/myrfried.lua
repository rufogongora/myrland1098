...
function creatureSayCallback(cid, type, msg)
	...
	local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_PRIVATE and 0 or cid
        ...
        elseif msgcontains(msg, 'tutores') or msgcontains(msg, 'informacion') then
            selfSay('Si deseas saber mas, visita la pagina del {myrland}, www.myrland.org.', cid)
	    ...
	    elseif msgcontains(msg, 'trainers') then
            selfSay('Los trainers se encuentran bajo el {mercado}, hay 2 zonas aqui en reynosa.', cid)
