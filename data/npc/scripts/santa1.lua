...
function santaNPC(cid, message, keywords, parameters, node) 
    ...
    if (parameters.present == true) then 
        if (getPlayerStorageValue(cid, PRESENT_STORAGE) < 1) then 
            ...
            npcHandler:say('HO HO HO! Te portaste como un pequeño dwarf este año! Tengo ' .. count .. getItemNameById(reward) .. ' para ti.', cid) 
        else 
...
local node = keywordHandler:addKeyword({'reg'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Te portaste bien este año?'}) 
